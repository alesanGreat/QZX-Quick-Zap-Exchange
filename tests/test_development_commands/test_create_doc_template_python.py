"""Tests for createDocTemplatePython safety and observable behavior."""

import ast
from pathlib import Path

from qzx.commands.development.create_doc_template_python import (
    CreateDocTemplatePythonCommand,
)
...
class TestCreateDocTemplatePythonCommand:
    def setup_method(self):
        self.command = CreateDocTemplatePythonCommand()
