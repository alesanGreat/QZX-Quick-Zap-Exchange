...
PyPI hosts the QZX `0.2.2.0.6a9` pre-release with Python `>=3.13`
...
|---|---:|---:|---|
| Published pre-release | `0.2.2.0.6a9` | `>=3.13`; standard CPython 3.13.x is certified | 89 commands reconciled with the official wheel |
...
## Good starting commands in PyPI pre-release 0.2.2.0.6a9
