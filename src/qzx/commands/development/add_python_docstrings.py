...
"""
AddPythonDocstrings Command - Generates documentation templates for Python code
"""
...
class AddPythonDocstringsCommand(CommandBase):
    ...
    def _requested_high_risk_mutation(self, values):
        """Request approval and a backup only for a real file mutation."""
    ...
    def execute(
        ...
        try:
            ...
            if not dry_run_value and changes_detected:
