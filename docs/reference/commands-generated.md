...
> Generated on: 2026-07-30 02:28:37
...
**Parameters:**
- `command`: Allowlisted diagnostic command to execute - Required
- `args`: Arguments passed directly to the command without shell expansion - Optional (default: `[]`)

**Examples:**
- `qzx commandsBridge pwd`
  Shows the current working directory
- `qzx bridge whoami`
  Shows the current operating-system user
- `qzx cmd ping 127.0.0.1`
  Runs a local network diagnostic
- `qzx run hostname`
