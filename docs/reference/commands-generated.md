...
> Generated on: 2026-07-30 00:47:35
...
**Parameters:**
- `path`: Directory path to scan and clean (default: '.') - Optional (default: `.`)
- `dry_run`: If True, only show what would be done without modifying any files (default: True) - Optional (default: `True`)
- `categories`: List of categories to clean: build, temp, artifacts, duplicates, reorganizations (default: all) - Optional (default: `build,temp,artifacts,duplicates,reorganizations`)
- `apply`: Must be True alongside dry_run=False to actually delete/modify files (default: False) - Optional (default: `False`)

**Examples:**
- `qzx repairWorkspace`
  Scan the workspace for build directories, temp files, duplicates, and reorganizations (dry-run)
- `qzx repairWorkspace --dry_run False --apply True`
  Actually delete/clean and reorganize the detected files
