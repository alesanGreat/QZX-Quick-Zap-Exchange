...
> Generated on: 2026-07-24 01:56:45

## Table of Contents

- [Development Commands](#development-commands)
  - [analyzeComplexity](#analyzecomplexity)
  - [auditLanguages](#auditlanguages)
...
**Parameters:**
- `scan_path`: Path to scan for programming language files (defaults to current directory) - Optional (default: `.`)
- `threshold`: Minimum file count threshold to analyze a language (default is 3) - Optional (default: `3`)

**Examples:**
- `qzx auditLanguages`
  Audit languages in the current directory
- `qzx auditLanguages "src/" 5`
  Audit languages in the src/ directory with a minimum file count of 5
...
- `qzx inspectPort 3000 true --yolo`
  Terminate the process when no restorable filesystem target exists
