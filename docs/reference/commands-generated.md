...
> Generated on: 2026-07-29 23:34:57
...
**Parameters:**
- `bump`: Semantic version bump type: patch, minor, major (default: 'patch') - Optional (default: `patch`)
- `path`: Path to project directory (default: '.') - Optional (default: `.`)
- `dry_run`: If True, simulate release without mutating files or running git commits (default: True) - Optional (default: `True`)

**Examples:**
- `qzx releaseProject`
  Preview a patch release
- `qzx releaseProject --bump minor --dry_run false`
  Back up and run a minor release
