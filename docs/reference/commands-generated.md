...
> Generated on: 2026-07-29 15:56:21
...
- `qzx compressZip project.zip .`
  Compress the current directory into project.zip, excluding standard build folders
- `qzx compressZip src.zip src`
  Compress the src folder into src.zip
...
- `qzx copyFile sourcedir destinationdir -r true`
...
- `qzx decompressZip project.zip`
  Extract project.zip into the current directory
...
- `qzx moveFile sourcedir destinationdir -r true`
  Move a directory recursively and overwrite if exists
