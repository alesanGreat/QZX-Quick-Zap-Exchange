...
> Generated on: 2026-07-30 02:58:39
...
**Parameters:**
- `path`: Path to the directory to bootstrap (default: '.') - Optional (default: `.`)
- `tech`: Technology stack: python, node, rust, php, cpp, typescript (optional, auto-detected if not specified) - Optional
- `dry_run`: If True, simulate the bootstrap process without writing/running commands (default: True) - Optional (default: `true`)

**Examples:**
- `qzx bootstrapProject`
  Preview bootstrap of the current project
- `qzx bootstrapProject --tech python --dry_run false`
  Back up and bootstrap a Python project
- `qzx bootstrapProject --dry_run True`
...
**Parameters:**
- `command`: Read-only diagnostic. Windows: hostname, ipconfig, netstat, whoami. Unix: cal, date, free, hostname, netstat, ps, ss, uname, uptime, who, whoami - Required
