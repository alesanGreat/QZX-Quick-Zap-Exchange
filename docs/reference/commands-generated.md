...
- [System Commands](#system-commands)
  ...
  - [listStartupPrograms](#liststartupprograms)
...
**Examples:**
- `qzx diagnoseProject`
  Diagnose the current project without running its scripts
- `qzx diagnoseProject C:/my/project`
...
**Examples:**
- `qzx findUnusedCode`
  Find unused-code candidates in the current directory
- `qzx findUnusedCode "src/"`
  Find unused-code candidates in the src/ directory
...
**Examples:**
- `qzx calculateFileHash file.txt`
  Calculate SHA-256 hash for file.txt
- `qzx calculateFileHash file.txt md5`
...
- `args`: Arguments passed to the script; QZX does not add their values to result metadata, but the script can print them in captured output - Optional (default: `[]`)
...
- `qzx runScript myscript.py arg1 arg2 --yolo`
  Execute with two arguments without QZX adding their values to result metadata
...
**Examples:**
- `qzx version`
  Display the installed QZX version and product identity
- `qzx --version`
  Display the installed QZX version using the global flag
