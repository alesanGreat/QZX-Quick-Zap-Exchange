...
> Generated on: 2026-07-30 00:35:33
...
- `recursive`: For directories: -r/--recursive to copy all contents, -rN/--recursiveN for N levels deep - Optional
- `force`: Replace an existing destination after creating a safety backup - Optional (default: `False`)
...
- `qzx copyFile sourcedir destinationdir -r`
  Copy a directory recursively (all contents)
- `qzx copyFile sourcedir destinationdir -r2`
  Copy a directory recursively up to 2 levels deep
- `qzx copyFile sourcedir destinationdir -r --force`
  Replace an existing destination after creating a safety backup
...
- `source`: Path to the source file or directory - Required
- `destination`: Path to the destination file or directory - Required
- `recursive`: For directories: -r/--recursive to move all contents, -rN/--recursiveN for N levels deep - Optional
- `force`: Replace an existing destination after creating a safety backup - Optional (default: `False`)
...
- `qzx moveFile sourcedir destinationdir -r`
  Move a directory recursively (all contents)
- `qzx moveFile sourcedir destinationdir -r2`
  Move a directory recursively up to 2 levels deep
